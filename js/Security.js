class Security {
    ...
    constructor(){
        ...
        this.answer1="VARIABLE";
        this.answer2="FUNCTION";
        this.answer3="DATABASE";
...
//add code for creating and positioning the third input box and button
    ...
    display(){
        ...
        this.button1.mousePressed(() => {
            if(system.authenticate(this.answer1,this.access1.value())){
                this.button1.hide();
                this.access1.hide();
                score++;
        ...
        this.button2.mousePressed(() => {
            if(system.authenticate(this.answer2,this.access2.value())){
                this.button2.hide();
                this.access2.hide();
                score++;
...
//add code for what happens when the third button is pressed
        ...
        this.button3.mousePressed(() => {
            if(system.authenticate(this.answer3,this.access3.value())){
                this.button3.hide();
                this.access3.hide();
                score++;
